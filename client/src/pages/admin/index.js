/**
 * Admin/Management Pages Barrel Exports
 * 
 * Centralizes exports for all administrative and management
 * components used by admin users.
 */

export { default as ManageExamPage } from './ManageExamPage';
