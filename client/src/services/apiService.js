 ...
 * };
 */
export const get_all_users = () => api_call('/api/admin/accounts/get_all_users');
 ...
 * }
 */
export const create_user = (user_data) => api_call('/api/admin/accounts/create-new-account', {
    method: 'POST',
    body: JSON.stringify(user_data),
});
...
export const add_new_subject = (subject_data) => api_call('api/subjects/add-new-subject', {
    method: 'POST',
